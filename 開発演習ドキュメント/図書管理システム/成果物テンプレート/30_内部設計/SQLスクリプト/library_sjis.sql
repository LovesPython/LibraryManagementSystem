...
-- ユーザ台帳テーブルのデータ
INSERT INTO member(member_name, member_address, member_tel, member_email, member_password, member_birthday, joined_at, canceled_at, is_staff, created_at, updated_at) VALUES('木田浩志', '愛媛県宇和島市桜町4-11', '0893508232', 'kouji798@gyayvcqea.dml', DEFAULT, '1983-07-13', '2010-01-01', null, '1', DEFAULT, DEFAULT);
INSERT INTO member(member_name, member_address, member_tel, member_email, member_password, member_birthday, joined_at, canceled_at, is_staff, created_at, updated_at) VALUES('笠井成美', '大阪府枚方市印田町3-20', '0616085193', 'Narumi_Kasai@zana.zazaf.nd', DEFAULT, '1964-01-21', DEFAULT, null, '0', DEFAULT, DEFAULT);
INSERT INTO member(member_name, member_address, member_tel, member_email, member_password, member_birthday, joined_at, canceled_at, is_staff, created_at, updated_at) VALUES('川端由紀江', '長崎県佐世保市宇久町木場2-9-12', '0953395747', 'yukie1281@zdiczyosqw.rw', DEFAULT, '1992-01-31', DEFAULT, null, '0', DEFAULT, DEFAULT);
INSERT INTO member(member_name, member_address, member_tel, member_email, member_password, member_birthday, joined_at, canceled_at, is_staff, created_at, updated_at) VALUES('南部広行', '群馬県邑楽郡板倉町朝日野3-9', '0279154153', 'hiroyuki5474@rcuwbue.tatz.xmn', DEFAULT, '1988-12-15', DEFAULT, null, '0', DEFAULT, DEFAULT);
...
-- 資料台帳テーブルのサンプルデータ
INSERT INTO document_ledger(isbn_no, added_at, discarded_at, note, created_at, updated_at) VALUES('1234567890', '1995-4-8', '2003-8-5', '劣化のため廃棄', DEFAULT, DEFAULT);
