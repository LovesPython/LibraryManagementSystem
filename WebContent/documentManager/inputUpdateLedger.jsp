...
<body>
  ...
  <form  action="#" method="post">
    ...
    入荷年月日：<input type="text" name="addedAt" value="smp入荷年月日"><br>
    廃棄年月日：<input type="text" name="discardedAt" value="smp廃棄年月日"><br>
    備考：<input type="text" name="note" value="smp備考"><br>
